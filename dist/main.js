...
var kn = /^((children|dangerouslySetInnerHTML|key|ref|autoFocus|defaultValue|defaultChecked|innerHTML|suppressContentEditableWarning|suppressHydrationWarning|valueLink|abbr|accept|acceptCharset|accessKey|action|allow|allowUserMedia|allowPaymentRequest|allowFullScreen|allowTransparency|alt|async|autoComplete|autoPlay|capture|cellPadding|cellSpacing|challenge|charSet|checked|cite|classID|className|cols|colSpan|content|contentEditable|contextMenu|controls|controlsList|coords|crossOrigin|data|dateTime|decoding|default|defer|dir|disabled|disablePictureInPicture|download|draggable|encType|enterKeyHint|form|formAction|formEncType|formMethod|formNoValidate|formTarget|frameBorder|headers|height|hidden|high|href|hrefLang|htmlFor|httpEquiv|id|inputMode|integrity|is|keyParams|keyType|kind|label|lang|list|loading|loop|low|marginHeight|marginWidth|max|maxLength|media|mediaGroup|method|min|minLength|multiple|muted|name|nonce|noValidate|open|optimum|pattern|placeholder|playsInline|poster|preload|profile|radioGroup|readOnly|referrerPolicy|rel|required|reversed|role|rows|rowSpan|sandbox|scope|scoped|scrolling|seamless|selected|shape|size|sizes|slot|span|spellCheck|src|srcDoc|srcLang|srcSet|start|step|style|summary|tabIndex|target|title|translate|type|useMap|value|width|wmode|wrap|about|datatype|inlist|prefix|property|resource|typeof|vocab|autoCapitalize|autoCorrect|autoSave|color|incremental|fallback|inert|itemProp|itemScope|itemType|itemID|itemRef|on|option|results|security|unselectable|accentHeight|accumulate|additive|alignmentBaseline|allowReorder|alphabetic|amplitude|arabicForm|ascent|attributeName|attributeType|autoReverse|azimuth|baseFrequency|baselineShift|baseProfile|bbox|begin|bias|by|calcMode|capHeight|clip|clipPathUnits|clipPath|clipRule|colorInterpolation|colorInterpolationFilters|colorProfile|colorRendering|contentScriptType|contentStyleType|cursor|cx|cy|d|decelerate|descent|diffuseConstant|direction|display|divisor|dominantBaseline|dur|dx|dy|edgeMode|elevation|enableBackground|end|exponent|externalResourcesRequired|fill|fillOpacity|fillRule|filter|filterRes|filterUnits|floodColor|floodOpacity|focusable|fontFamily|fontSize|fontSizeAdjust|fontStretch|fontStyle|fontVariant|fontWeight|format|from|fr|fx|fy|g1|g2|glyphName|glyphOrientationHorizontal|glyphOrientationVertical|glyphRef|gradientTransform|gradientUnits|hanging|horizAdvX|horizOriginX|ideographic|imageRendering|in|in2|intercept|k|k1|k2|k3|k4|kernelMatrix|kernelUnitLength|kerning|keyPoints|keySplines|keyTimes|lengthAdjust|letterSpacing|lightingColor|limitingConeAngle|local|markerEnd|markerMid|markerStart|markerHeight|markerUnits|markerWidth|mask|maskContentUnits|maskUnits|mathematical|mode|numOctaves|offset|opacity|operator|order|orient|orientation|origin|overflow|overlinePosition|overlineThickness|panose1|paintOrder|pathLength|patternContentUnits|patternTransform|patternUnits|pointerEvents|points|pointsAtX|pointsAtY|pointsAtZ|preserveAlpha|preserveAspectRatio|primitiveUnits|r|radius|refX|refY|renderingIntent|repeatCount|repeatDur|requiredExtensions|requiredFeatures|restart|result|rotate|rx|ry|scale|seed|shapeRendering|slope|spacing|specularConstant|specularExponent|speed|spreadMethod|startOffset|stdDeviation|stemh|stemv|stitchTiles|stopColor|stopOpacity|strikethroughPosition|strikethroughThickness|string|stroke|strokeDasharray|strokeDashoffset|strokeLinecap|strokeLinejoin|strokeMiterlimit|strokeOpacity|strokeWidth|surfaceScale|systemLanguage|tableValues|targetX|targetY|textAnchor|textDecoration|textRendering|textLength|to|transform|u1|u2|underlinePosition|underlineThickness|unicode|unicodeBidi|unicodeRange|unitsPerEm|vAlphabetic|vHanging|vIdeographic|vMathematical|values|vectorEffect|version|vertAdvY|vertOriginX|vertOriginY|viewBox|viewTarget|visibility|widths|wordSpacing|writingMode|x|xHeight|x1|x2|xChannelSelector|xlinkActuate|xlinkArcrole|xlinkHref|xlinkRole|xlinkShow|xlinkTitle|xlinkType|xmlBase|xmlns|xmlnsXlink|xmlLang|xmlSpace|y|y1|y2|yChannelSelector|z|zoomAndPan|for|class|autofocus)|(([Dd][Aa][Tt][Aa]|[Aa][Rr][Ii][Aa]|x)-.*))$/, xn = /* @__PURE__ */ Sn(
  ...
  /* Z+1 */
), w = "-ms-", pe = "-moz-", y = "-webkit-", It = "comm", Ne = "rule", nt = "decl", _n = "@import", Tt = "@keyframes", En = "@layer", Dt = Math.abs, rt = String.fromCharCode, We = Object.assign;
function Cn(e, t) {
...
function R() {
  return C = O < Mt ? A(oe, O++) : 0, ee++, C === 10 && (ee = 1, Oe++), C;
}
function F() {
  return A(oe, O);
}
...
function Nn(e) {
  return Oe = ee = 1, Mt = I(oe = e), O = 0, [];
}
function On(e) {
  return oe = "", e;
}
function Be(e) {
  return jt(Ie(O - 1, Ue(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Rn(e) {
  for (; (C = F()) && C < 33; )
    R();
...
function jn(e) {
  return On(xe("", null, null, null, [""], e = Nn(e), 0, [0], e));
}
function xe(e, t, n, r, o, s, i, a, c) {
  for (var u = 0, d = 0, f = i, g = 0, h = 0, v = 0, k = 1, $ = 1, x = 1, _ = 0, b = "", S = o, E = s, m = r, p = b; $; )
    switch (v = _, _ = R()) {
      case 40:
        if (v != 108 && A(p, f - 1) == 58) {
          Se(p += l(Be(_), "&", "&\f"), "&\f", Dt(u ? a[u - 1] : 0)) != -1 && (x = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (_) {
          ...
          case 125:
            $ = 0;
          case 59 + d:
            x == -1 && (p = l(p, /\f/g, "")), h > 0 && I(p) - f && ue(h > 32 ? mt(p + ";", r, n, f - 1, c) : mt(l(p, " ", "") + ";", r, n, f - 2, c), c);
            break;
          case 59:
            p += ";";
          default:
            if (ue(m = ht(p, t, n, u, d, o, a, b, S = [], E = [], f, s), s), _ === 123)
              if (d === 0)
                ...
                switch (g === 99 && A(p, 3) === 110 ? 100 : g) {
                  ...
                  case 109:
                  case 115:
                    xe(e, m, m, r && ue(ht(e, m, m, 0, 0, o, a, b, o, S = [], f, E), E), o, E, f, a, r ? S : E);
                    break;
                  default:
                    xe(p, m, m, m, [""], E, 0, a, E);
                }
      ...
      default:
        ...
        switch (p += rt(_), _ * k) {
          ...
          case 44:
            ...
            break;
          case 64:
            F() === 45 && (p += Be(R())), g = F(), d = f = I(b = p += Dn(ke())), _++;
            break;
          case 45:
            v === 45 && I(p) == 2 && (k = 0);
        }
...
function ht(e, t, n, r, o, s, i, a, c, u, d, f) {
  for (var g = o - 1, h = o === 0 ? s : [""], v = zt(h), k = 0, $ = 0, x = 0; k < r; ++k)
    for (var _ = 0, b = Q(e, g + 1, g = Dt($ = i[k])), S = e; _ < v; ++_)
      (S = jt($ > 0 ? h[_] + " " + b : l(b, /&\f/g, h[_]))) && (c[x++] = S);
  return Re(e, t, n, o === 0 ? Ne : a, c, u, d, f);
}
function zn(e, t, n, r) {
  return Re(e, t, n, It, rt($n()), Q(e, 2, -2), 0, r);
}
function mt(e, t, n, r, o) {
  return Re(e, t, n, nt, Q(e, 0, r), Q(e, r + 1, -1), r, o);
}
function Lt(e, t, n) {
  switch (Cn(e, t)) {
    case 5103:
        ...
        switch (A(e, t + 1)) {
          case 109:
            if (A(e, t + 4) !== 45)
              break;
          case 102:
            return l(e, /(.+:)(.+)-([^]+)/, "$1" + y + "$2-$3$1" + pe + (A(e, t + 3) == 108 ? "$3" : "$2-$3")) + e;
          case 115:
            return ~Se(e, "stretch", 0) ? Lt(l(e, "stretch", "fill-available"), t, n) + e : e;
        }
      break;
    case 5152:
    case 5920:
...
function Bn(e, t, n, r) {
  if (e.length > -1 && !e.return)
    switch (e.type) {
      case nt:
        e.return = Lt(e.value, e.length, n);
        return;
      case Tt:
        return Ce([z(e, { value: l(e.value, "@", "@" + y) })], r);
      case Ne:
        if (e.length)
          return An(n = e.props, function(o) {
            switch (D(o, r = /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                X(z(e, { props: [l(o, /:(read-\w+)/, ":" + pe + "$1")] })), X(z(e, { props: [o] })), We(e, { props: ft(n, r) });
                break;
              case "::placeholder":
                X(z(e, { props: [l(o, /:(plac\w+)/, ":" + y + "input-$1")] })), X(z(e, { props: [l(o, /:(plac\w+)/, ":" + pe + "$1")] })), X(z(e, { props: [l(o, /:(plac\w+)/, w + "input-$1")] })), X(z(e, { props: [o] })), We(e, { props: ft(n, r) });
                break;
            }
            return "";
          });
...
var Fn = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, Y = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", Ht = "active", Bt = "data-styled-version", Te = "6.1.8", ot = `/*!sc*/
`, st = typeof window < "u" && "HTMLElement" in window, Gn = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), gt = /invalid hook call/i, ge = /* @__PURE__ */ new Set(), Vn = function(e, t) {
...
To resolve this only create new StyledComponents outside of any render method and function component.`, o = console.error;
    try {
      ...
      console.error = function(i) {
        ...
        gt.test(i) ? (s = !1, ge.delete(r)) : o.apply(void 0, J([i], a, !1));
      }, mn(), s && !ge.has(r) && (console.warn(r), ge.add(r));
    } catch (i) {
      gt.test(i.message) && ge.delete(r);
    } finally {
      console.error = o;
    }
  }
...
var Xe = /* @__PURE__ */ new Set(["a", "abbr", "address", "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "big", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "data", "datalist", "dd", "del", "details", "dfn", "dialog", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "html", "i", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "legend", "li", "link", "main", "map", "mark", "menu", "menuitem", "meta", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "script", "section", "select", "small", "source", "span", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "u", "ul", "use", "var", "video", "wbr", "circle", "clipPath", "defs", "ellipse", "foreignObject", "g", "image", "line", "linearGradient", "marker", "mask", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "stop", "svg", "text", "tspan"]), Wn = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g, qn = /(^-|-$)/g;
function yt(e) {
  return e.replace(Wn, "-").replace(qn, "");
}
var Un = /(a)(d)/gi, ye = 52, vt = function(e) {
  return String.fromCharCode(e + (e > 25 ? 39 : 97));
};
function Ke(e) {
  var t, n = "";
  for (t = Math.abs(e); t > ye; t = t / ye | 0) n = vt(t % ye) + n;
  return (vt(t % ye) + n).replace(Un, "$1-$2");
}
var Fe, Ft = 5381, H = function(e, t) {
...
var Yt = typeof Symbol == "function" && Symbol.for, Wt = Yt ? Symbol.for("react.memo") : 60115, Kn = Yt ? Symbol.for("react.forward_ref") : 60112, Zn = { childContextTypes: !0, contextType: !0, contextTypes: !0, defaultProps: !0, displayName: !0, getDefaultProps: !0, getDerivedStateFromError: !0, getDerivedStateFromProps: !0, mixins: !0, propTypes: !0, type: !0 }, Jn = { name: !0, length: !0, prototype: !0, caller: !0, callee: !0, arguments: !0, arity: !0 }, qt = { $$typeof: !0, compare: !0, defaultProps: !0, displayName: !0, propTypes: !0, type: !0 }, Qn = ((Fe = {})[Kn] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }, Fe[Wt] = qt, Fe);
function bt(e) {
  return ("type" in (t = e) && t.type.$$typeof) === Wt ? qt : "$$typeof" in e ? Qn[e.$$typeof] : Zn;
  var t;
}
var er = Object.defineProperty, tr = Object.getOwnPropertyNames, wt = Object.getOwnPropertySymbols, nr = Object.getOwnPropertyDescriptor, rr = Object.getPrototypeOf, St = Object.prototype;
function Ut(e, t, n) {
  if (typeof t != "string") {
    if (St) {
      var r = rr(t);
    ...
    var o = tr(t);
    wt && (o = o.concat(wt(t)));
    for (var s = bt(e), i = bt(t), a = 0; a < o.length; ++a) {
      var c = o[a];
...
function se(e) {
  ...
  return process.env.NODE_ENV === "production" ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(sr.apply(void 0, J([or[e]], t, !1)).trim());
}
var ir = function() {
  function e(t) {
  ...
  return e.prototype.indexOfGroup = function(t) {
    ...
    for (var r = this.groupSizes[t], o = this.indexOfGroup(t), s = o + r, i = o; i < s; i++) n += "".concat(this.tag.getRule(i)).concat(ot);
    return n;
  }, e;
}(), _e = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Ee = 1, ve = function(e) {
  if (_e.has(e)) return _e.get(e);
  for (; Ae.has(Ee); ) Ee++;
  var t = Ee++;
  if (process.env.NODE_ENV !== "production" && ((0 | t) < 0 || t > 1073741824)) throw se(16, "".concat(t));
  return _e.set(e, t), Ae.set(t, e), t;
}, ar = function(e, t) {
  Ee = t + 1, _e.set(e, t), Ae.set(t, e);
}, cr = "style[".concat(Y, "][").concat(Bt, '="').concat(Te, '"]'), lr = new RegExp("^".concat(Y, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), ur = function(e, t, n) {
  for (var r, o = n.split(","), s = 0, i = o.length; s < i; s++) (r = o[s]) && e.registerName(t, r);
}, pr = function(e, t) {
  for (var n, r = ((n = t.textContent) !== null && n !== void 0 ? n : "").split(ot), o = [], s = 0, i = r.length; s < i; s++) {
    var a = r[s].trim();
    if (a) {
      var c = a.match(lr);
      if (c) {
        var u = 0 | parseInt(c[1], 10), d = c[2];
        u !== 0 && (ar(d, u), ur(e, d, c[3]), e.getTag().insertRules(u, o)), o.length = 0;
      } else o.push(a);
    }
  }
};
...
var Xt = function(e) {
  ...
  r.setAttribute(Y, Ht), r.setAttribute(Bt, Te);
  var i = dr();
  return i && r.setAttribute("nonce", i), n.insertBefore(r, s), r;
}, fr = function() {
  function e(t) {
    this.element = Xt(t), this.element.appendChild(document.createTextNode("")), this.sheet = function(n) {
  ...
  function e(t) {
    this.element = Xt(t), this.nodes = this.element.childNodes, this.length = 0;
  }
  return e.prototype.insertRule = function(t, n) {
...
}(), xt = st, gr = { isServer: !st, useCSSOMInjection: !Gn }, Kt = function() {
  function e(t, n, r) {
    t === void 0 && (t = te), n === void 0 && (n = {});
    var o = this;
    this.options = P(P({}, gr), t), this.gs = n, this.names = new Map(r), this.server = !!t.isServer, !this.server && st && xt && (xt = !1, function(s) {
      for (var i = document.querySelectorAll(cr), a = 0, c = i.length; a < c; a++) {
        var u = i[a];
        u && u.getAttribute(Y) !== Ht && (pr(s, u), u.parentNode && u.parentNode.removeChild(u));
      }
      ...
      return function(s) {
        for (var i = s.getTag(), a = i.length, c = "", u = function(f) {
          ...
          h !== void 0 && h.forEach(function(x) {
            x.length > 0 && ($ += "".concat(x, ","));
          }), c += "".concat(v).concat(k, '{content:"').concat($, '"}').concat(ot);
        }, d = 0; d < a; d++) u(d);
        return c;
      }(o);
    });
  ...
  return e.registerId = function(t) {
    ...
    return this.tag || (this.tag = (t = function(n) {
      ...
      return n.isServer ? new mr(o) : r ? new fr(o) : new hr(o);
...
function br(e) {
  ...
  d.push(function(g) {
    g.type === Ne && g.value.includes("&") && (g.props[0] = g.props[0].replace(yr, n).replace(r, u));
  }), i.prefix && d.push(Bn), d.push(Mn);
  var f = function(g, h, v, k) {
    h === void 0 && (h = ""), v === void 0 && (v = ""), k === void 0 && (k = "&"), t = k, n = h, r = new RegExp("\\".concat(n, "\\b"), "g");
    var $ = g.replace(vr, ""), x = jn(v || h ? "".concat(v, " ").concat(h, " { ").concat($, " }") : $);
    i.namespace && (x = Zt(x, i.namespace));
    var _ = [];
    return Ce(x, Ln(d.concat(Hn(function(b) {
      return _.push(b);
    })))), _;
  };
...
var wr = new Kt(), Je = br(), Jt = V.createContext({ shouldForwardProp: void 0, styleSheet: wr, stylis: Je });
Jt.Consumer;
...
var Et = function() {
  function e(t, n) {
    ...
    }, this.name = t, this.id = "sc-keyframes-".concat(t), this.rules = n, at(this, function() {
...
var Qt = function(e) {
  ...
  for (var o in e) {
    var s = e[o];
    e.hasOwnProperty(o) && !Qt(s) && (Array.isArray(s) && s.isCss || ne(s) ? r.push("".concat(Ct(o), ":"), s, ";") : re(s) ? r.push.apply(r, J(J(["".concat(o, " {")], en(s), !1), ["}"], !1)) : r.push("".concat(Ct(o), ": ").concat((t = o, (n = s) == null || typeof n == "boolean" || n === "" ? "" : typeof n != "number" || n === 0 || t in Fn || t.startsWith("--") ? String(n).trim() : "".concat(n, "px")), ";")));
  }
  return r;
};
function G(e, t, n, r) {
  ...
  if (ne(e)) {
    ...
    var o = e(t);
    return process.env.NODE_ENV === "production" || typeof o != "object" || Array.isArray(o) || o instanceof Et || re(o) || o === null || console.error("".concat(Vt(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), G(o, t, n, r);
  }
  var s;
  return e instanceof Et ? n ? (e.inject(n, r), [e.getName(r)]) : [e] : re(e) ? en(e) : Array.isArray(e) ? Array.prototype.concat.apply(De, e.map(function(i) {
    return G(i, t, n, r);
  })) : [e.toString()];
}
function kr(e) {
  for (var t = 0; t < e.length; t += 1) {
    var n = e[t];
    if (ne(n) && !it(n)) return !1;
  }
  return !0;
}
var xr = Gt(Te), _r = function() {
  function e(t, n, r) {
    this.rules = t, this.staticRulesId = "", this.isStatic = process.env.NODE_ENV === "production" && (r === void 0 || r.isStatic) && kr(t), this.componentId = n, this.baseHash = H(xr, n), this.baseStyle = r, Kt.registerId(n);
  }
  return e.prototype.generateAndInjectStyles = function(t, n, r) {
    ...
    if (this.isStatic && !r.hash) if (this.staticRulesId && n.hasNameForId(this.componentId, this.staticRulesId)) o = B(o, this.staticRulesId);
      ...
      var s = kt(G(this.rules, t, n, r)), i = Ke(H(this.baseHash, s) >>> 0);
...
}(), tn = V.createContext(void 0);
tn.Consumer;
var Ve = {}, At = /* @__PURE__ */ new Set();
function Er(e, t, n) {
  var r = it(e), o = e, s = !Ge(e), i = t.attrs, a = i === void 0 ? De : i, c = t.componentId, u = c === void 0 ? function(S, E) {
    var m = typeof S != "string" ? "sc" : yt(S);
    Ve[m] = (Ve[m] || 0) + 1;
    var p = "".concat(m, "-").concat(Xn(Te + m + Ve[m]));
    return E ? "".concat(E, "-").concat(p) : p;
  }(t.displayName, t.parentComponentId) : c, d = t.displayName, f = d === void 0 ? function(S) {
    return Ge(S) ? "styled.".concat(S) : "Styled(".concat(Vt(S), ")");
  }(e) : d, g = t.displayName && t.componentId ? "".concat(yt(t.displayName), "-").concat(t.componentId) : t.componentId || u, h = r && o.attrs ? o.attrs.concat(a).filter(Boolean) : a, v = t.shouldForwardProp;
  ...
  var x = new _r(n, g, r ? o.componentStyle : void 0);
  function _(S, E) {
    return function(m, p, M) {
      var q = m.attrs, ln = m.componentStyle, un = m.defaultProps, pn = m.foldedComponentIds, ut = m.styledComponentId, dn = m.target, fn = V.useContext(tn), hn = _t(), je = m.shouldForwardProp || hn.shouldForwardProp;
      process.env.NODE_ENV !== "production" && dt(ut);
      var pt = Yn(p, fn, un) || te, T = function(fe, le, he) {
      ...
      for (var N in T) T[N] === void 0 || N[0] === "$" || N === "as" || N === "theme" && T.theme === pt || (N === "forwardedAs" ? ce.as = T.forwardedAs : je && !je(N, ae) || (ce[N] = T[N], je || process.env.NODE_ENV !== "development" || xn(N) || At.has(N) || !Xe.has(ae) || (At.add(N), console.warn('styled-components: it looks like an unknown prop "'.concat(N, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var ze = function(fe, le) {
        var he = _t(), U = fe.generateAndInjectStyles(le, he.styleSheet, he.stylis);
  ...
  } }), process.env.NODE_ENV !== "production" && (Vn(f, g), b.warnTooManyClasses = /* @__PURE__ */ function(S, E) {
    var m = {}, p = !1;
    return function(M) {
...
Example:
  ...
  }), s && Ut(b, e, { attrs: !0, componentStyle: !0, displayName: !0, foldedComponentIds: !0, shouldForwardProp: !0, styledComponentId: !0, target: !0 }), b;
}
function $t(e, t) {
...
function ie(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  if (ne(e) || re(e)) return Pt(G($t(De, J([e], t, !0))));
  var r = e;
  return t.length === 0 && r.length === 1 && typeof r[0] == "string" ? G(r) : Pt(G($t(r, t)));
}
function Qe(e, t, n) {
...
const Nt = "#ffffff", Cr = "#ec0016", rn = "#f75056", Ar = "#fa9090", $r = "#1455c0", Ot = "#347de0", Pr = "#b4d5f6", Nr = "#55b9e6", $e = "#646973", de = "#878c96", ct = "#afb4bb", Pe = "#d7dce1";
function on(e) {
  const [t, n] = et(!1);
